...
if (count($clientes) > 0) {
    foreach ($clientes as $c) {
        $cliente         = htmlspecialchars($c['cliente']);
        $cantidad_ventas = (int)$c['cantidad_ventas'];
...
<div class="titulo-reporte">
    <h2 class="text-main">Reporte de Clientes Más Frecuentes</h2>
    <div class="subtitulo">
...
<div class="kpi-container">
    <table class="kpi-table">
        <tr>
            <td class="kpi-label">Cantidad de clientes:</td>
            <td class="kpi-value">' . $total_clientes . '</td>
        </tr>
        <tr>
            <td class="kpi-label">Total de ventas (operaciones):</td>
            <td class="kpi-value">' . $total_ventas_global . '</td>
        </tr>
        <tr>
            <td class="kpi-label">Total facturado:</td>
...
<div class="separador">Detalle por cliente</div>
...
// Podés cambiar a 'landscape' si lo preferís horizontal
$dompdf->setPaper('A4', 'portrait');

$dompdf->render();
$dompdf->stream('reporte_clientes_frecuentes.pdf', ['Attachment' => false]);
exit;
