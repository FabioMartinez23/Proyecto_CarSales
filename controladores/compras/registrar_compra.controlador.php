        ...
        try {
            ...
            foreach ($campos_obligatorios as $campo) {
                if (empty($_POST[$campo])) {
                    throw new Exception('Todos los datos del vehículo son obligatorios.');
                }
            }
            ...
            if (!$titular->agregar_titular()) {
                throw new Exception('Error al agregar titular al vehículo.');
            }
            ...
            if (empty($_POST['descripcion_carroceria']) || empty($_POST['descripcion_neumatico']) || empty($_POST['vencimiento_rto'])) {
                throw new Exception('Los datos de la ficha técnica son obligatorios.');
            }
            ...
            if (!$ficha_tecnica->agregar_ficha_tecnica()) {
                throw new Exception('Error al agregar ficha técnica.');
            }
            ...
            if (!isset($precio_tipo_array['tomado'])) {
                throw new Exception('No se encontró el tipo de precio "tomado".');
            }
            ...
            if (!$precio->actualizar_precio()) {
                throw new Exception('Error al agregar el precio.');
            }

            /* ===============================================================
               8️⃣ REGISTRAR COMPRA
            =============================================================== */
