...
if (isset($_GET['buscador']) && !empty($_GET['buscador'])) {
    ...
    $result_usuarios = $usuario->traer_clientes($inicio, $filas_por_pagina);
}
...
<div class="col hacer_padding">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a type="button" class="btn btn-action" href="index.php?page=registrar_clientes&accion=registrar">Registrar Nuevo Cliente</a>
        ...
        <div class="table-responsive">
            <table id="tabla_clientes" class="table table-hover text-center align-middle">
                <thead>
                    <tr>
                    <th>Nombre</th>
                    <th>Apellido</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?page=registrar_clientes&idusuarios=<?=$usuario_['idusuarios']; ?>&nombre=<?=$usuario_['username'];?>" class="btn btn-success" type="button" title="Modificar Cliente">
        ...
        <nav aria-label="..." class="d-flex justify-content-center">
            <ul class="pagination">
                ...
                <li class="page-item <?php if ($pagina_actual <= 1) { echo 'disabled'; } ?>">
                    <a class="page-link" href="index.php?page=listado_clientes&pagina_actual=<?= $pagina_actual - 1 ?>" aria-disabled="true">Previo</a>
                </li>

                <!-- Botones de número de página -->
                <?php for ($i = 1; $i <= $total_paginas; $i++) { ?>
                    <li class="page-item <?php if ($pagina_actual == $i) { echo 'active'; } ?>">
                        <a class="page-link" href="index.php?page=listado_clientes&pagina_actual=<?= $i ?>"><?= $i ?></a>
                    </li>
                <?php } ?>

                <!-- Botón "Siguiente" -->
                <li class="page-item <?php if ($pagina_actual >= $total_paginas) { echo 'disabled'; } ?>">
                    <a class="page-link" href="index.php?page=listado_clientes&pagina_actual=<?= $pagina_actual + 1 ?>">Siguiente</a>
                </li>
            </ul>
        </nav>
    </div>
...
<script>
    function buscador(){
        ...
        location.href='index.php?page=listado_clientes&buscador='+buscador;
    }
