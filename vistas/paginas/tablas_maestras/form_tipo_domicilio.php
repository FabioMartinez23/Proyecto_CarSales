    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_domicilios.php?page=form_tipo_domicilio&idtipo_domicilio=<?=$tipo_domicilio['idtipo_domicilio']; ?>&descripcion=<?=$tipo_domicilio['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_domicilio['idtipo_domicilio']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_domicilio.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idtipo_domicilio" value="<?= $tipo_domicilio['idtipo_domicilio'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_domicilio['idtipo_domicilio']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
