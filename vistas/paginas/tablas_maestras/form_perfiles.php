    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_perfiles.php?page=form_perfiles&idperfiles=<?=$perfil['idperfiles']; ?>&descripcion=<?=$perfil['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $perfil['idperfiles']; ?>" method="POST" action="../controladores/tablas_maestras/perfil.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idperfiles" value="<?= $perfil['idperfiles'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $perfil['idperfiles']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
