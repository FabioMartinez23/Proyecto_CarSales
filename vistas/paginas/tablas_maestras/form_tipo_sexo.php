    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_personas.php?page=form_tipo_sexo&idtipo_sexo=<?=$tipo_sexo['idtipo_sexo']; ?>&descripcion=<?=$tipo_sexo['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_sexo['idtipo_sexo']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_sexo.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idtipo_sexo" value="<?= $tipo_sexo['idtipo_sexo'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_sexo['idtipo_sexo']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
