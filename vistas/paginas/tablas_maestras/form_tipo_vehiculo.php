    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_vehiculos.php?page=form_tipo_vehiculo&idtipo_vehiculos=<?=$tipo_vehiculo['idtipo_vehiculos']; ?>&nombre=<?=$tipo_vehiculo['nombre'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_vehiculo['idtipo_vehiculos']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_vehiculo.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idtipo_vehiculos" value="<?= $tipo_vehiculo['idtipo_vehiculos'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_vehiculo['idtipo_vehiculos']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
