    ...
    <div class="col">
        ...
        <?php }?>
            <div class="mb-3">
                ...
                <input <?php if(isset($_GET['idtipo_contacto'])){ foreach($tipo_contacto_editar as $tipo_contacto){ echo "value='".$tipo_contacto['descripcion']."'";}} ?> type="text" name="descripcion" onfocusout="validate_tipo_contacto(event)" class="form-control" id="idtipo_contacto" aria-describedby="emailHelp">
    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_personas.php?page=form_tipo_contacto&idtipo_contacto=<?=$tipo_contacto['idtipo_contacto']; ?>&descripcion=<?=$tipo_contacto['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_contacto['idtipo_contacto']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_contacto.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idtipo_contacto" value="<?= $tipo_contacto['idtipo_contacto'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_contacto['idtipo_contacto']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
