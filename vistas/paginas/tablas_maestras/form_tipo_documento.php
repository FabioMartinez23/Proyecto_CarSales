    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_personas.php?page=form_tipo_documento&idTipo_documento=<?=$tipo_documento['idTipo_documento']; ?>&descripcion=<?=$tipo_documento['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_documento['idTipo_documento']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_documento.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idTipo_documento" value="<?= $tipo_documento['idTipo_documento'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_documento['idTipo_documento']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
