    ...
    <div class="col">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a href="form_datos_para_operaciones.php?page=form_tipo_puesto&idtipo_de_puestos=<?=$tipo_puesto['idtipo_de_puestos']; ?>&descripcion=<?=$tipo_puesto['descripcion'];?>" class="btn btn-success" type="button">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </td>

                <td>
                    <form id="formulario-eliminar-<?= $tipo_puesto['idtipo_de_puestos']; ?>" method="POST" action="../controladores/tablas_maestras/tipo_puesto.controlador.php">
                        <input type="hidden" name="action" value="eliminar">
                        <input type="hidden" name="idtipo_de_puestos" value="<?= $tipo_puesto['idtipo_de_puestos'] ?>">
                        <button onclick="confirmarAccion(event, 'eliminar', 'formulario-eliminar-<?= $tipo_puesto['idtipo_de_puestos']; ?>')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                    </form>
                </td>
                </tr>
                        <?php
