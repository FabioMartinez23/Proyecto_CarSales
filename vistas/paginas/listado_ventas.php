...
<div class="mt-5 hacer_padding">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <a type="button" href="index.php?page=registrar_ventas" class="btn mt-2 mb-2 btn-action">
    ...
    <div class="table-responsive">
        <table id="ventasTable" class="table table-striped align-middle">
            <thead>
                <tr>
                    <th>Nro de Venta</th>
            ...
            <nav aria-label="..." class="d-flex justify-content-center">
                <ul class="pagination">
                    ...
                    <li class="page-item <?php if ($pagina_actual <= 1) { echo 'disabled'; } ?>">
                        <a class="page-link"
                           href="index.php?page=listado_ventas&pagina_actual=<?= max(1, $pagina_actual - 1); ?>">
                            Previo
                        </a>
                    </li>
                    ...
                    <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
                        <li class="page-item <?php if ($pagina_actual == $i) { echo 'active'; } ?>">
                            <a class="page-link"
                               href="index.php?page=listado_ventas&pagina_actual=<?= $i; ?>">
                                <?= $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <li class="page-item <?php if ($pagina_actual >= $total_paginas) { echo 'disabled'; } ?>">
                        <a class="page-link"
                           href="index.php?page=listado_ventas&pagina_actual=<?= min($total_paginas, $pagina_actual + 1); ?>">
                            Siguiente
                        </a>
                    </li>
                </ul>
...
function buscador() {
    ...
    location.href = 'index.php?page=listado_ventas&buscador=' + encodeURIComponent(buscador);
}
