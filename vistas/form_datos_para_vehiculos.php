...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_vehiculos.php?page=form_marca">Marcas</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_vehiculos.php?page=form_modelo_vehiculo">Modelos</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_vehiculos.php?page=form_tipo_vehiculo">Tipo de Vehiculos</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_vehiculos.php?page=form_color">Colores</a>
            </li>
        </ul>
    </div>
</nav>

<h1 class="text-center mb-4">Gestion de Datos para Vehiculos</h1>
</header>
