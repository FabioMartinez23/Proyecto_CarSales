...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_personas.php?page=form_tipo_sexo">Tipo de Sexo</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_personas.php?page=form_tipo_documento">Tipo de Documentos</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_personas.php?page=form_tipo_contacto">Tipo de Contactos</a>
            </li>
        </ul>
    </div>
</nav>

<h1 class="text-center mb-4">Gestion de Datos para Personas</h1>
</header>
