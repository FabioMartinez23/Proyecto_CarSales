...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_domicilios.php?page=form_barrio">Barrios</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_domicilios.php?page=form_localidad">Localidades</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_domicilios.php?page=form_provincia">Provincias</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_domicilios.php?page=form_pais">Paises</a>
            </li>
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="form_datos_para_domicilios.php?page=form_tipo_domicilio">Tipo de Domicilios</a>
            </li>
        </ul>
    </div>
</nav>

<h1 class="text-center mb-4">Gestion de Datos para Domicilios</h1>
</header>
